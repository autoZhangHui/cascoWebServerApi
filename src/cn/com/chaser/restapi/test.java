...
public class RestService1 extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (method.equals("dqfx")) {
			...
			String startTime = ((String) requestJson.get("start_at"))
					.substring(0, 10).replaceAll("-", "");
			String endTime = ((String) requestJson.get("end_at")).substring(0,
					10).replaceAll("-", "");
			...
			try {
				data = HbaseSet.runHbase(test, "AnalysisResult", startTime,endTime);
			} catch (Exception e) {
...
>>>>>>> 0adaf4e456706bb678c30c856c0192210529d893
}
